var APP = APP || {};
APP.main = webpackJsonpAPP__name_(
  [1],
  {
    196: function (t, e, n) {
      "use strict";
      !(function (t) {
        ...
        function l(t, e) {
          t.sort(function (t, n) {
            return (
              s(e ? n : t).parents().length - s(e ? t : n).parents().length
            );
          });
        }
        var s = function t(e) {
          return {
            ...
            append: function (t) {
              for (
                var n = Array.prototype.slice.call(t), i = 0, o = n.length;
                i < o;
                ++i
              )
                e.appendChild(n[i]);
            ...
            insertBefore: function (t) {
              if (t.parentNode) return t.parentNode.insertBefore(e, t);
            },
            remove: function () {
            ...
            parents: function () {
              for (var t, n = []; (t = e.parentNode); ) n.push(t), (e = t);
              return n;
            },
            normalizeTextNodes: function () {
              if (e) {
                ...
                else t(e.firstChild).normalizeTextNodes();
            ...
            getRange: function () {
              var n,
                i = t(e).getSelection();
              return i.rangeCount > 0 && (n = i.getRangeAt(0)), n;
            },
        ...
        function c(t, e) {
          if (!t) throw "Missing anchor element";
          var n, i;
          (this.el = t),
            (this.options = r(e, {
              color: "#ffff7b",
        ...
        (c.prototype.destroy = function () {
          ...
          (c.prototype.doHighlight = function (t) {
            var e,
              ...
              o,
              a,
              r = s(this.el).getRange();
            r &&
              !r.collapsed &&
              !0 === this.options.onBeforeHighlight(r) &&
              ((a = +new Date()),
          ...
          (c.prototype.highlightRange = function (t, n) {
            ...
            var a,
              ...
              c = (function (t) {
                ...
                if (0 === t.endOffset) {
                  ...
                  n.nodeType === i.TEXT_NODE
                    ? t.endOffset < n.nodeValue.length &&
                      n.splitText(t.endOffset)
                    : t.endOffset > 0 &&
                      (n = n.childNodes.item(t.endOffset - 1));
                return (
                  e.nodeType === i.TEXT_NODE
                    ? t.startOffset === e.nodeValue.length
                      ? (a = !1)
                      : t.startOffset > 0 &&
                        n ===
                          (e = e.splitText(t.startOffset)).previousSibling &&
                        (n = e)
                    : (e =
                        t.startOffset < e.childNodes.length
                          ? e.childNodes.item(t.startOffset)
                          : e.nextSibling),
                  { startContainer: e, endContainer: n, goDeeper: a }
                );
              })(t),
              d = c.startContainer,
              h = c.endContainer,
            ...
            do {
              u &&
                g.nodeType === i.TEXT_NODE &&
                (-1 === o.indexOf(g.parentNode.tagName) &&
                  "" !== g.nodeValue.trim() &&
                  ((r = n.cloneNode(!0)).setAttribute(e, !0),
                  (l = g.parentNode),
                  (s(this.el).contains(l) || l === this.el) &&
                    ((l.style !== r.style && l.style.backgroundColor) ||
                      ((a = s(g).wrap(r)), p.push(a)))),
                (u = !1)),
                g !== h || (h.hasChildNodes() && u) || (f = !0),
                g.tagName &&
                  o.indexOf(g.tagName) > -1 &&
                  (h.parentNode === g && (f = !0), (u = !1)),
                u && g.hasChildNodes()
                  ? (g = g.firstChild)
                  : g.nextSibling
                  ? ((g = g.nextSibling), (u = !0))
          ...
          (c.prototype.normalizeHighlights = function (t) {
            var e;
            return (
              this.flattenNestedHighlights(t),
            ...
            function i() {
              ...
              return (
                t.forEach(function (i, o) {
                  ...
                  n.isHighlight(r) &&
                    (a(r, i)
                      ? (r.replaceChild(i.firstChild, i), (t[o] = r), (e = !0))
                      : (i.nextSibling || (s(i).insertBefore(c || r), (e = !0)),
                        i.previousSibling ||
                          (s(i).insertAfter(l || r), (e = !0)),
          ...
          (c.prototype.mergeSiblingHighlights = function (t) {
            ...
            t.forEach(function (t) {
              var e = t.previousSibling,
                i = t.nextSibling;
              n(t, e) && (s(t).prepend(e.childNodes), s(e).remove()),
                n(t, i) && (s(t).append(i.childNodes), s(i).remove()),
          ...
          (c.prototype.removeHighlights = function (t) {
            var e = t || this.el,
              n = this.getHighlights({ container: e }),
              o = this;
            function a(t) {
              s(t)
                .unwrap()
                .forEach(function (t) {
                  ...
                  (n = (e = t).previousSibling),
                    ...
                    n &&
                      n.nodeType === i.TEXT_NODE &&
                      ((e.nodeValue = n.nodeValue + e.nodeValue),
                      s(n).remove()),
                    o &&
                      o.nodeType === i.TEXT_NODE &&
                      ((e.nodeValue = e.nodeValue + o.nodeValue),
                      s(o).remove());
                });
            }
            l(n, !0),
                ...
                (o = (function (t) {
                  ...
                  return (
                    t.forEach(function (t) {
                      ...
                      void 0 === i[o] && ((i[o] = []), e.push(o)), i[o].push(t);
                    }),
            ...
            return (
              ...
              t.forEach(function (t) {
                ...
                (l.innerHTML = ""),
                  (l = l.outerHTML),
                  t.previousSibling &&
                    t.previousSibling.nodeType === i.TEXT_NODE &&
                    (o = t.previousSibling.length),
                ...
                try {
                  !(function (t) {
                    for (
                      ...
                      d = d.childNodes[r];
                    d.childNodes[c - 1] &&
                      d.childNodes[c - 1].nodeType === i.TEXT_NODE &&
                      (c -= 1),
                      (e = (d = d.childNodes[c]).splitText(l.offset)).splitText(
                        l.length
                      ),
                      e.nextSibling &&
                        !e.nextSibling.nodeValue &&
                        s(e.nextSibling).remove(),
                      e.previousSibling &&
                        !e.previousSibling.nodeValue &&
                        s(e.previousSibling).remove(),
          ...
          (c.prototype.find = function (t, e) {
            var n = s(this.el).getWindow(),
              ...
              o = n.scrollY,
              a = void 0 === e || e;
            if ((s(this.el).removeAllRanges(), n.find))
              for (; n.find(t, a); ) this.doHighlight(!0);
            else if (n.document.body.createTextRange) {
              var r = n.document.body.createTextRange();
              for (
                r.moveToElementText(this.el);
                r.findText(t, 1, a ? 4 : 0) &&
                (s(this.el).contains(r.parentElement()) ||
                  r.parentElement() === this.el);

              )
                r.select(), this.doHighlight(!0), r.collapse(!1);
            }
            s(this.el).removeAllRanges(), n.scrollTo(i, o);
          }),
    ...
    22: function (t, e, n) {
      ...
      function o(t, e) {
        for (var n = new Object(), i = new Object(), o = 0; o < e.length; o++)
          null == n[e[o]] && (n[e[o]] = { rows: new Array(), o: null }),
            n[e[o]].rows.push(o);
        for (o = 0; o < t.length; o++)
          null == i[t[o]] && (i[t[o]] = { rows: new Array(), n: null }),
            i[t[o]].rows.push(o);
        for (var o in n)
          1 == n[o].rows.length &&
            void 0 !== i[o] &&
            1 == i[o].rows.length &&
            ((e[n[o].rows[0]] = { text: e[n[o].rows[0]], row: i[o].rows[0] }),
            (t[i[o].rows[0]] = { text: t[i[o].rows[0]], row: n[o].rows[0] }));
        for (o = 0; o < e.length - 1; o++)
          null != e[o].text &&
            null == e[o + 1].text &&
            e[o].row + 1 < t.length &&
            null == t[e[o].row + 1].text &&
            e[o + 1] == t[e[o].row + 1] &&
            ((e[o + 1] = { text: e[o + 1], row: e[o].row + 1 }),
            (t[e[o].row + 1] = { text: t[e[o].row + 1], row: o + 1 }));
        ...
        (e.diffString3 = function (t, e, n) {
          ...
          if ((null == h ? (h = ["\n"]) : h.push("\n"), 0 == l.n.length))
            for (var u = 0; u < l.o.length; u++) {
              ...
              null == l.co[u].text && (f = "<pron>" + f + "</pron>"), (c += f);
            }
          else {
            if (null == l.n[0].text)
      ...
      (function (t, e) {
        ...
        n(211),
          ...
          t(document).on("click", ".notification > button.delete", function () {
            return t(this).parent().addClass("is-hidden"), !1;
          }),
          t.ajaxSetup({
            beforeSend: function (t, e) {
              /^(GET|HEAD|OPTIONS|TRACE)$/i.test(e.type) ||
                this.crossDomain ||
                t.setRequestHeader("X-CSRFToken", window.csrf_token);
            },
          }),
          (t.valHooks.textarea = {
            get: function (t) {
        ...
        (window.generate_qs = function (t) {
          ...
          (window.isSafari = /^((?!chrome|android).)*safari/i.test(
            navigator.userAgent
          ));
        var v = function (e, n, o, a, r, l) {
          (null !== a && void 0 !== a) ||
            (a = function (t, e) {
              return null != e && alert(e.responseText), !1;
            });
          r = void 0 === r || null === r ? {} : r;
          var s = {
            url: e,
          ...
          if ("object" === (void 0 === o ? "undefined" : (0, i.default)(o)))
            try {
              s.data = t.param(o, !0);
            } catch (t) {
              (s.processData = !1), (s.contentType = !1);
            }
          !0 === l &&
            ...
            o &&
              ...
              t.get(o, function (e) {
                ...
                c.html(n),
                  ...
                  i &&
                    (0, u.each)(i, function (t, e) {
                      n.find("form").attr(t, e);
                    }),
                  n.find(".ckeditor").length && CKEDITOR.replaceAll("ckeditor"),
                  n.find(".django-ckeditor").length &&
                    initialiseCKEditor(".django-ckeditor"),
                  n.find(".ckeditoruploadingwidget").length &&
                    initialiseCKEditor(".ckeditoruploadingwidget"),
                  n.find(".jqhtml-loader").length &&
                    n.find(".jqhtml-loader").each(function (t, e) {
                      load_jqhtml(e);
                    });
              }));
          }),
            ...
            t(".post-video-item").each(function (t) {
              if (!("true" == this.getAttribute("loaded"))) {
                var e = new a.default(this, {
                  ...
                  speed: {
                    selected: 1,
                    options: [0.5, 0.8, 0.9, 1, 1.1, 1.25, 1.5, 1.75, 2, 4],
                  },
                });
                    ...
                    var n = "true" === this.getAttribute("no-extra-controls"),
                      ...
                      o = new a.default(this, {
                        ...
                        speed: {
                          selected: 1,
                          options: [
                            0.5, 0.8, 0.9, 1, 1.1, 1.25, 1.5, 1.75, 2, 4,
                          ],
                        },
                      });
                    ...
                    r
                      ...
                      i &&
                        r
                          .find('[role="menu"]')
                          .append(
                            '\n                    <a data-plyr="download" type="button" class="plyr__control" download target="_blank" href="' +
                              o.download +
                              '"><span>Download</span></a>\n                '
                          ),
                      r.on("click", '[data-plyr="reload"]', function () {
                        l.find("source").length
                          ? l
                              .find("source")
                              .attr(
                                "src",
                                m(o.source, "v", "" + new Date().getTime())
                              )
                          : l.attr(
                              "src",
                              m(o.source, "v", "" + new Date().getTime())
        ...
        (window.topFunction = function () {
          ...
          t(function () {
            ...
            (e = {}),
              ...
              document.querySelectorAll("form").forEach(function (t) {
                t.classList.contains("form-prevent-doubleclick") &&
              ...
              t(document).arrive("form", function () {
                var e = t(this)[0];
                e.classList.contains("form-prevent-doubleclick") &&
              ...
              t(document).on("click", ".jqinline-form-form-btn", function () {
                ...
                e.hide(), i.show(), load_jqhtml(o[0], null, null, a, null);
              }),
            ...
            var n;
            window.params = decodeURIComponent(n || document.location.search)
              .replace(/(^\?)/, "")
              .replace(/\+/g, " ")
              .split("&")
              .map(
            ...
            if (
              ((document.body.scrollTop > 20 ||
                ...
                document.getElementById("site-scrollTop") &&
                (document.getElementById("site-scrollTop").style.display =
                  "block"),
              t(document).on("click", ".question-ordering div", function () {
                var e = t(this),
                ...
                if (!n.attr("readonly")) {
                  ...
                  if (i) {
                    var a = "--" + i + "--";
                    -1 != o.indexOf(a)
                      ? ((o = o.replaceAll(a, "")), e.removeClass("selected"))
                      : (e.addClass("selected"), (o = o += a)),
                      n.attr("data-txt", o),
                      n.val(o.replaceAll("--", "")),
                      n.change();
                  }
            ...
            t(".jqcarousel").on("click", ".jqcarousel-thumbnail", function (e) {
              ...
              return (
                i.find(".jqcarousel-thumbnail").removeClass("active"),
                n.addClass("active"),
                a.attr("src", r),
                o.attr("href", l),
                s.attr("href", l),
            ...
            try {
              window.lightbox_links = t(
                ".jqlightbox .jqlightbox-link"
              ).simpleLightbox({ loadingTimeout: 10 });
            } catch (t) {
              window.lightbox_links = null;
            }
            try {
              window.carousel_lightbox_links = t(
                ".jqlightbox-carousel .jqlightbox-link"
              ).simpleLightbox({
                loadingTimeout: 10,
                history: !1,
                loop: !1,
            ...
            (window.lazy = new r.default({
                      ...
                      c.trigger("callback", [t]),
                        ...
                        a.length
                          ? (c.modal("hide"),
                            ...
                            a.modal("show"))
                          : i.length
                          ? (c.modal("hide"), load_jqhtml(i[0], null, null, o))
                          : r
                          ? c.modal("hide")
                          : t.redirect
              ...
              t(document).on("click", ".jqaction-link", function (e) {
                if (
                  (e.preventDefault(), window.current_user.is_authenticated)
                ) {
                  var n = t(this),
                    i = this.getAttribute("data-href"),
                    o =
                      this.getAttribute("data-redirect_url") ||
                  ...
                  v(i, "POST", null, function (t, e) {
                    ...
                    var i = !0;
                    s && (n.toggleClass(s), (i = !1)),
                      c && (n.text(c), (i = !1)),
                      l.length && (load_jqhtml(l[0]), (i = !1)),
                      i && (location.href = o);
                  });
                } else
                  location.href =
              ...
              t(document).on(
                "keypress",
                '.jqinputs-search input[type="text"]',
                function (e) {
                  if (13 == e.which) {
                    var n = t(this),
              ...
              t(document).on("click", ".jqtoggle", function (e) {
                ...
                return i.hasClass(o) ? i.removeClass(o) : i.addClass(o), !1;
              }),
              ...
              t(document).on("keyup", ".jqwordcount", function (e) {
                ...
                if (!n.attr("data-norecount")) {
                  ...
                  this.value
                    ...
                    n
                      .siblings(".jqwordcount-show")
                      .text("Word count: " + i.length);
                }
              }),
              ...
              t(document).on("click", ".flashcard-review-option", function () {
                ...
                if (!e.hasClass("checked")) {
                  ...
                  e
                    .find(".flashcard-review-option-number")
                    .replaceWith(
                      '<span class="flashcard-review-option-result ' +
                        o +
                        '"></span>'
                    ),
                    e.addClass("checked"),
              ...
              t(document).on(
                ...
                function (e) {
                  if (13 == (e.keyCode || e.which)) {
                    var n = t(this);
                    if (
                      (n.removeClass("correct").removeClass("wrong"),
                      !n.val().trim())
                    )
                      return;
                    var i = n.attr("data-href"),
                      o =
                        n.attr("data-answer").trim().toLowerCase() ==
                        n.val().trim().toLowerCase()
                          ? 1
                          : 0,
                      a = 1 == o ? "correct" : "wrong";
                    n.addClass(a),
                      t.post(i, { action: o }, function () {
                        1 == o &&
                          setTimeout(function () {
                            location.reload();
                          }, 1e3);
              ...
              t(document).on(
                "click",
                ".flashcard-review-showanswer",
                function () {
                  var e = t(this)
                      .parents(".flashcard-review-shortanswer")
                      .find(".flashcard-review-input"),
                    n = e.attr("data-href");
                  e.removeClass("correct").removeClass("wrong"),
                    e.val(e.attr("data-answer")),
                    e.addClass("answer"),
                    e.attr("disabled", "true"),
                    t.post(n, { action: 0 }, function () {});
                }
              ),
              ...
              t(document).on("click", ".jq-audio-btn", function () {
                if (
                  window.jq_audio_item.duration > 0 &&
                  !window.jq_audio_item.paused
                )
                  window.jq_audio_item.pause();
                else {
                  ...
                  a &&
                    (window.jq_audio_item.src != encodeURI(a) &&
                      ((window.jq_audio_item.src = a),
                      window.jq_audio_item.load()),
                    window.jq_audio_item
                      .play()
                      .then(function () {})
                      .catch(function (t) {
                        e.find("source").length
                          ? e
                              .find("source")
                              .attr("src", m(a, "v", "" + new Date().getTime()))
                          : e.attr("src", m(a, "v", "" + new Date().getTime()));
                      }));
                }
              });
            ...
            function s() {
              ...
              e.length &&
                (window.pageYOffset > l - 90
                  ? e.hasClass("sticky") ||
                    (e.addClass("sticky"), e.parent().addClass("with-sticky"))
                  : e.hasClass("sticky") &&
                    (e.parent().removeClass("with-sticky"),
            ...
            s(),
                      ...
                      h.on("click", ".jqrecord-audio-start", function () {
                        if (!l) {
                          ...
                          if (!e.hasClass("disabled")) {
                            ...
                            try {
                              g =
                                "true" == e.attr("data-limit_answer_time")
                                  ? parseFloat(
                                      e.attr("data-time_limit_minutes")
                                    )
                                  : 0;
                            } catch (t) {}
                            e.hide(), h.show();
                            var p = null;
                            (p = g
                              ? window.startTimer(g, f[0], function () {
                                  h.click();
                                })
                                    ...
                                    (a = new c()),
                                      ...
                                      ((i = new WebAudioRecorder(o, {
                                        ...
                                        if (
                                          ...
                                          t
                                            .find(".jqrecord-audio-start")
                                            .removeClass("disabled"),
                                          t.find(".jqrecord-players").html(o),
                                          t.find(
                                            "input.jqrecord-audio-file-input"
                                          ).length)
                                        ) {
                                          var a = new File(
                                              [n],
                                          ...
                                          c.readAsDataURL(n),
                                            (c.onloadend = function () {
                                              var e = c.result;
                                              t.find(
                                                "input.jqrecord-audio-base64-input"
                                              )
                                                .val(e)
                                                .trigger("change");
                                            });
              ...
              (window.dictionary = new (function () {
                ...
                t(document).on("click", ".elevator-close", function () {
                  ...
                  n.animate({ right: "-42px" }, 200, function () {
                  ...
                  t(document).on("click", ".elevator-open", function () {
                    ...
                    n.find(".elevator-open").hide(),
                      n.animate({ right: "0" }, 200, function () {});
                  }),
                  n.on("click", function () {
                    r.attr("src") ||
                      r.attr(
                        "src",
                        e.find(".jqdictionary-tab.active").attr("data-href")
                      ),
                      e.show();
                  }),
                  i.on("click", function () {
              ...
              (window.hltr = (function (e) {
                ...
                s.length &&
                  s.on("click", ".highlight-color", function (e) {
                    e.preventDefault();
                    var n = t(this),
                      i = n[0].className;
                    f.setColor(n.css("background-color")),
                      i.indexOf("underred")
                        ? f.setUnderline(n.css("border-bottom"))
                        : f.setUnderline(""),
                      i.indexOf("crossed")
                        ? f.setCrossed(n.css("text-decoration"))
                        : f.setCrossed("");
                  });
                ...
                function u(e) {
                  c(), window.hltr.deserializeHighlights(e);
                  var n = t(".highlighted");
                  n.each(function (e, n) {
                    ...
                    "true" ==
                      f.closest(".text-highlightable").attr("data-draggable") &&
                      f.draggable(),
                      f.one("click", ".highlighted-note-remove", function () {
                        a.removeAttr("data-note"), f.remove();
                      }),
                      f.on("dblclick", function (t) {
                        "highlighted-note-remove" != t.target.className &&
                          (m(), v(f));
                      });
                  });
                }
                o.on("change", function () {
                  ...
                  r.on("click", function () {
                    var e = this.getAttribute("data-target"),
                      n = h();
                    return (
                      !(!n || !JSON.parse(n).length) &&
                      (t
                        .post(e, { data: n, highlight_id: i }, function (t) {
                          (i = t.highlight_id), u(n);
                        })
                        .fail(function (t, e, n) {}),
                      { data: n, highlight_id: i })
                    );
                  }),
                  l.on("change", function () {
                    ...
                    i != n &&
                      ((i = n),
                      t.get(e, { highlight_id: n }, function (t) {
                        var e = t.data;
                        u(e);
                      }));
                  });
                var f = new TextHighlighter(document.body, {
                        ...
                        !(
                          ...
                          "always" !=
                            t(e.commonAncestorContainer)
                              .closest(".text-highlightable")
                              .attr("data-highlightable")
                        ) &&
                        1 ==
                          t(e.commonAncestorContainer).closest(
                            ".text-highlightable"
                          ).length &&
                        !t(e.startContainer).hasClass("highlighted-note") &&
                        (p.appendTo(t(".text-highlightable").first()), !0)
                      );
                    },
                    onAfterHighlight: function (e, n) {
                      ...
                      n.map(function (e, n) {
                        ...
                        if (r.parent().hasClass("highlighted-note")) {
                          ...
                          a.push(r.parent()), f.removeHighlights(r[0]);
                        } else (o = n), r.attr("data-uid", i);
                      });
                      var r = t(n[o]),
                        l = !0,
                        s = !1,
                    ...
                    onRemoveHighlight: function (e) {
                      p.appendTo(t(".text-highlightable").first()), w();
                      var n = t(e);
                      return (
                        n.find(".highlighted-note").remove(),
                        n.text(n.text()),
                        !0
                      );
                    },
                ...
                function m(e) {
                  ...
                  p.attr("data-uid", n.attr("data-uid")),
                    n.find(".highlight-control").length
                      ? p.show()
                      : (p.appendTo(n),
                        p.css({ position: "absolute", left: 0, top: -35 }),
                        p.show());
                }
                function v(t) {
                  var t = t || null;
                  ...
                  if ((e.focus().val("").removeAttr("note-uid"), t)) {
                    e.val(t.text().trim());
                    var n = (0, d.v4)();
                    t.attr("note-uid", n), e.attr("note-uid", n);
                  }
                ...
                return (
                  p.on("click", ".highlight-flashcard", function (e) {
                    ...
                    if (n) {
                      ...
                      var a =
                        i.last().attr("data-note") || p.find("textarea").val();
                      (o = o.join(" ").trim()), (a = a.trim());
                      var r = i.last().attr("data-flashcard"),
                        l =
                          "/flashcards/terms/create/?view=clean&term=" +
                          o +
                          "&definition=" +
                          a +
                          "&result=json";
                  ...
                  p.on("click", ".highlight-remove", function (e) {
                    ...
                    var n = p.attr("data-uid");
                    n
                      ? t(".highlighted[data-uid=" + n + "]").each(function (
                          t,
                          e
                        ) {
                  ...
                  p.on("click", ".highlight-save", function (e) {
                    ...
                    if (n) {
                      ...
                      if (a) {
                        var l,
                          s,
                          c = i.last().attr("data-note") || "";
                        r
                          ? (s = (l = t(
                              ".highlighted-note[note-uid='" + r + "']"
                            ))
                              .text()
                              .trim())
                          : (l = t(g.replace("{{txt}}", a))),
                          ...
                          s
                            ...
                            : (i.last().attr("data-note", c + "*|*" + a),
                              i.last().append(l)),
                          "true" ==
                            l
                              .closest(".text-highlightable")
                              .attr("data-draggable") && l.draggable(),
                          l.one(
                            "click",
                            ".highlighted-note-remove",
                            function () {
                              i.removeAttr("data-note"), l.remove();
                            }
                          ),
                  ...
                  t("body").on("click", function (e) {
                    var n = t(e.target);
                    n.parents(".highlight-control").length ||
                  ...
                  (f.webStoreHighlights = function (e) {
                    var n = r.attr("data-target"),
                      o = h();
                    if (!o || !JSON.parse(o).length) return e();
                    t.post(n, { data: o, highlight_id: i }, function (t) {
                      return (i = t.highlight_id), u(o), e();
                    }).fail(function (t, e, n) {
                      return alert("Error saving, please try again!"), !1;
                    });
                  }),
                  (f.webRestoreHighlights = function () {
                    l.find("option").length <= 1 ||
                      (l.val(l.find("option")[1].value), l.change());
                  }),
                  f
                );
              })());
            ...
            c.length &&
              (c.arrive(".jqmedia-comment", function (e) {
                var n = t(this),
                ...
                i.html(
                  i
                    ...
                    .replaceAll(
                      /([0-5]?)[0-9](:|;)[0-5][0-9]/g,
                      '<span class="link jqmedia-comment-timestamp" data-timestamp="$&"><b>$&</b></span>'
                    )
                );
              }),
          ...
          (window.get_cuid = function () {
            var t = "study4_cuid_" + (window.current_user || { id: null }).id,
              e = localStorage.getItem(t);
            return e || ((e = (0, d.v4)()), localStorage.setItem(t, e)), e;
          }),
          (window.site_settings = new (function () {
            (this.current_user = window.current_user || { id: null }),
              (this.settings_key =
                "sitewide_user_settings_" + this.current_user.id),
              (this.settings = {}),
              (this.load = function () {
                var t = localStorage.getItem(this.settings_key);
                return t && (this.settings = JSON.parse(t)), t;
              }),
