                      ...
                      t.isRecovery
                        ...
                        : (t.styleCache &&
                            ...
                            t.dataset.swiperAnimation &&
                              t.classList.remove(t.dataset.swiperAnimation),
                            t.dataset.swiperOutAnimation &&
                              t.classList.remove(t.dataset.swiperOutAnimation)),
                          (t.isRecovery = !0),
                          setTimeout(function () {
                            return e();
                          }, 0));
                ...
                return this.allBoxes.length
                  ...
                  : new Promise(function (e) {
                      ...
                      var e = t.allBoxes.map(function (t) {
                        return new Promise(function (e) {
                          t.attributes.style
                            ? (t.styleCache = r + t.style.cssText)
                            : (t.styleCache = r),
                            (t.style.cssText = t.styleCache),
                            (t.isRecovery = !0),
                            setTimeout(e, 0);
              ...
              (t._initAllBoxes = function () {
                if (!this.allBoxes.length) {
                  ...
                  this.swiper.wrapperEl
                    ? (e = this.swiper.wrapperEl)
                    : this.swiper.wrapper && (e = this.swiper.wrapper[0]),
                    (this.allBoxes = n(
                      e.querySelectorAll("[data-swiper-animation]")
                    ));
                }
              }),
              (t._initPromisePolyfill = function (e) {
                if (
                  (void 0 === e && (e = function () {}), !this.appendedPromise)
                ) {
