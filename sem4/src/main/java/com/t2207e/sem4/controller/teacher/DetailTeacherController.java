...
public class DetailTeacherController {
    ...
    public String detail(Model model) {
        ...
        if (authentication != null && authentication.isAuthenticated()) {
            ...
            Optional<TeacherRegister> teacherRegister = teacherRegisterService.getTeacherRegisterByUser_UserId(user.getUserId());
            model.addAttribute("teacher", teacherRegister.get());
        }
